...
```
v0.9.9.16 — Manager lädt Plan aus PocketBase, "Aktuellen Plan bearbeiten"-Button (aktuell)
...
- **Manager + Crew laden Plan direkt aus PocketBase** — localStorage optional (seit v0.9.9.16)
