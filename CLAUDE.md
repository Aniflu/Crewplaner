...
- **73 Tests grün** (Stand v0.23.0). Test-Dateien (`tests/*.test.mjs`, auto-discovered von `run.mjs`):
...
Danach in Docker-Logs prüfen: `[hook] main.pb.js v4.8 geladen`
