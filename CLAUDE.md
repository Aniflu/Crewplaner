...
Aktuell deployte Hook-Version: **v4.9.1** (deployt 2026-07-19 durch Admin) — ⚠️ **Repo-Stand ist v4.9.2, RE-DEPLOY AUSSTEHEND** (Feed tour-spezifisch: Route `/ics/{token}/{plan}` + plan_id-Filter, v0.27.1). Feld `users.feed_token` ist angelegt + alle 10 User backfilled (2026-07-19 per Superuser).
...
Danach in Docker-Logs prüfen: `[hook] main.pb.js v4.9.2 geladen`
