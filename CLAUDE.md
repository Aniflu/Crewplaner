...
```
v0.9.9.12 — Crew-Ansicht überarbeitet, PB-Plan-Bereinigung, email case-insensitiv (aktuell)
...
- **Crew lädt Plan direkt aus PocketBase** — kein localStorage nötig (seit v0.9.9.12)
